...
function initRuntimeSocketService() {
  const hosts = "172.22.224.1,192.168.154.1,192.168.221.1,192.168.0.102,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_WHH1LX";
...
const pages = [
  ...
  {
    path: "pages/teacher/my-students",
    style: {
  ...
  {
    path: "pages/principal/assign",
    style: {
      navigationBarTitleText: "师生管理"
    }
  }
];
const globalStyle = {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","172.22.224.1","192.168.154.1","192.168.221.1","192.168.0.102"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/TOOL/TOOL/HBuilderX.4.76.2025082103/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"homework-01","spaceId":"mp-b63af61a-6e1e-4892-b437-582fca6baf1b","clientSecret":"SbsxbaHVAp4HSIkpCwsulA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__729EB59";
} catch (e2) {
